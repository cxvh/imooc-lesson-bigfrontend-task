...
## 演示图
![](https://qq507570355.oss-cn-beijing.aliyuncs.com/public/picture/github/20.png)
...
---
## 问题
使用 new CleanWebpackPlugin() 后，
第一次打包ok,第二次打包报错（剩余2文件），第三次打包ok,第四次报错，一直重复。不知道是什么情况
